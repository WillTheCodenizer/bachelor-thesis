...
agreement with a wide range of cosmological observations.
For the late-time Universe relevant for extragalactic sources, radiation and
curvature contributions are usually negligible. Therefore, the expansion 
history is mainly determined by the matter and dark energy density parameters,
...
This relation is used to describe the redshift evolution of the Hubble 
parameter and provides the connection between observations of distant sources 
and their cosmological distances.

HIER NOCHMAL EINE QUELLE FINDEN SODASS ALLES PASST UND EVENTUELL KUERZEN ES BRAUCHT VIELLECIHT DIE FORMEL GAR NICHT...UND CHECKEN MTI CHAT OB HIER PLAGIAT WARE WEIL EINFACH NUR REINKOPIERT
